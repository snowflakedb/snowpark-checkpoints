...
def fixture_registered_loggers() -> LoggerDict:
    ...
    # We need to import the snowflake.snowpark_checkpoints_collector module
    # to ensure the __init__.py file is executed.
    import_module("snowflake.snowpark_checkpoints_collector")
...
def test_loggers_exists(registered_loggers: LoggerDict):
    ...
    logger_names = {
        ...
        "snowflake.snowpark_checkpoints_collector.column_collection.column_collector_manager",
        "snowflake.snowpark_checkpoints_collector.column_pandera_checks.pandera_column_checks_manager",
        "snowflake.snowpark_checkpoints_collector.snow_connection_model.snow_connection",
